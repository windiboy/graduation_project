...
int main(int argc, char** argv)
{
  ...
  // work flow
  while(ros::ok()){
    visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to 原位");
    ...
    visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to 抓门");
    // Planning to a pick
    // ^^^^^^^^^^^^^^^^^^^^^^^
    // try{
    ...
    visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to 下压");
    ...
    visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to 前推");
